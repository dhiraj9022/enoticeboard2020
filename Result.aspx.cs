...
public partial class Result : System.Web.UI.Page
{
    ...
    protected void btnupload_Click(object sender, EventArgs e)
    {
        ...
        string path = Server.MapPath("~/UploadFiles/result/");
        if (flupload.HasFile)
        {
            ...
            if (ext == ".jpeg" || ext == ".jpg" || ext == ".png" || ext == ".pdf" || ext == ".gif")
            {
                ...
                string img = "~/UploadFiles/result/" + flupload.FileName;
                string query = "Insert into ResultStructure values(@Name,@Image)";
